 ...
 */
public class Udgeeth extends BaseAasanActivity {
    ...
    {
        Intent intent = new Intent(context, Udgeeth.class);
    ...
    {
        return FireRef.REF_AASAN_UDGEETH;
    }
    ...
    {
        return getString(R.string.benefit_udgeeth);
    }
